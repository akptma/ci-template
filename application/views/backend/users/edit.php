        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form action="<?= base_url('user/update/' . encode($user->id)); ?>" method="post" class="form">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class=" form-group">
                                            ...
                                            <input type="text" name="username" id="username" value="<?= $user->username; ?>" class="form-control" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="role_id" id="role_id" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Priority" data-original-title="" title="">
                                                <?php foreach ($roles as $role) : ?>
                                                    <option value="<?= $role->id; ?>" <?= ($role->id == $user->role_id ? 'selected' : ''); ?>><?= ucwords($role->nama_role); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
