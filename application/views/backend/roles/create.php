        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form action="<?= base_url('role/store'); ?>" method="post" class="form">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_role" id="nama_role" value="<?= set_value('nama_role'); ?>" class="form-control" required>
